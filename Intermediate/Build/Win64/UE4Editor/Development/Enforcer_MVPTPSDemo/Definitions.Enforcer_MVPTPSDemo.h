...
#define ORIGINAL_FILE_NAME "UE4Editor-Enforcer_MVPTPSDemo.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME Enforcer_MVPTPSDemo
#define DEPRECATED_FORGAME DEPRECATED
#define ENFORCER_MVPTPSDEMO_API DLLEXPORT
